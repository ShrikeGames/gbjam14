...
func _on_kill_area_body_entered(body: Node2D) -> void:
	if body and is_instance_of(body, Friend) and body.global_position.y > self.global_position.y+16 and abs(self.linear_velocity.length()) > 0.1 :
